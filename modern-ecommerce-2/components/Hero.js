        ...
        <div className="md:grid md:grid-cols-12 md:gap-12 lg:gap-20 items-center">
          ...
          <div className="md:col-span-5 lg:col-span-5 text-center md:text-right" data-aos="fade-up" data-aos-delay="450">
            <div className="inline-flex relative justify-center items-center">
              ...
              {/* iPhone mockup */}
              <Image className="relative max-w-full mx-auto md:mr-0 md:max-w-none h-auto pointer-events-none" src={IphoneMockup} width="344" height="674" alt="iPhone mockup" aria-hidden="true" />
